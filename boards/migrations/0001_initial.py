# Generated by Django 5.1 on 2024-09-24 10:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_liked_by', models.ManyToManyField(blank=True, default=None, related_name='post_like', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('post_like_value', models.CharField(choices=[('♥️', '♥️'), ('♡', '♡')], default='♥️', max_length=2)),
